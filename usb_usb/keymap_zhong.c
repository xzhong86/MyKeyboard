...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [LAYER_SPCFN] = KEYMAP_K60(TRNS, TRNS, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12, TRNS, TRNS, NO, NO, WINL, WINR, NO, NO, PGUP, UP, END, PSCR, TRNS, TRNS, TRNS, TRNS, NO, NO, NO, NO, NO, HOME, LEFT, DOWN, RGHT, NO, NO, TRNS, TRNS, NO, DEL, NO, NO, NO, PGDN, NO, BSPC, DEL, NO, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS),
